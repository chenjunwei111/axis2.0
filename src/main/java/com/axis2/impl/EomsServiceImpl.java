...
//正常的查询
    public static String sql="select  a.NSN_PARENT_ID city,a.NSN_ID region, b.order_name,a.UE_X,a.UE_Y,b.order_theme," +
            ...
            "b.customer_level,b.home_subscriber,b.complaint_acceptance_province,b.fault_msisdn," +
            "b.fault_area,b.complain_city,a.PROPERTY appeal_area,a.crm_ordernum,b.terminal_description," +
            ...
            " from TEMP_CP_COMPLAIN_LIST_ORDER_V1 T,FINAL_ANALYSIS_TABLE_V2_1 F  WHERE " +
...
//                System.out.println(sendxml);
    ...
    public void turnAnalyReport2(String sendSheet) {
        //调用肖老板的HTTP 请求代码
        NsnServiceImpl.analyTurnToEoms(sqltest);
    }
    ...
    public static void main(String[] args) {
        ...
        eomsService.turnAnalyReport2(sqltest);
