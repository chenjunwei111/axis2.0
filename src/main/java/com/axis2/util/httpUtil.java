...
//            System.out.println(String.valueOf(xmlData.length));
                ...
                log.info("发送HTTP请求失败1.0,写入后台数据库");
                String sql = "INSERT INTO nsn_response_failed_detail_table (xmlInfo,URL,orderNum,eomsNum,sendNum,millis,remarks) VALUES " + "(" + "'" + xmlInfo + "','" + URL + "','" + orderNum + "','" + eomsNum + "','" + sendNum + "','" + millis +"','" +e.toString() +"')";
                Connection conn = jdbcUtil.getConnection();
                PreparedStatement pstmt = null;
                ResultSet rs = null;
                //执行sql
