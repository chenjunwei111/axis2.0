...
public class PeriodTask extends NsnServiceImpl{
    ...
    public static String sql_redo ="select  a.NSN_PARENT_ID city,a.NSN_ID region, b.order_name,a.UE_X,a.UE_Y,b.order_theme," +
    ...
    public static void re_post_ordernum(String sql_redo){
        log.info("定期针对没有回传的工单继续回传");
        PeriodTask pt=new PeriodTask();
        pt.analyTurnToEoms(sql_redo);
    }
