 ...
 **/
public class JdbcServer169 {
    static Logger logger = Logger.getLogger(JdbcServer.class);
    static String driver = "oracle.jdbc.driver.OracleDriver";
    static String url = ConfigReaderUtils.getProperty("url169");
    static String username = ConfigReaderUtils.getProperty("username169");
    static String password = ConfigReaderUtils.getProperty("password169");
	/*static String url = "";
