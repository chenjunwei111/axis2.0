    ...
    public JSONArray  nsnTurnAnalyReport() {
        ...
        String sql_bak = "select  a.NSN_PARENT_ID city,a.NSN_ID region, b.order_name,a.UE_X,a.UE_Y," +
            ...
            String sql="select  a.NSN_PARENT_ID city,a.NSN_ID region, b.order_name,a.UE_X,a.UE_Y,"
                    + "b.order_theme,b.order_time,b.accept_time_limit,b.complain_time," +
                    "b.customer_name,b.customer_tel,b.complain_area,  b.complain_content," +
                    "b.large_area_complain,b.repeated_complaints,b.customer_level,b.home_subscriber," +
                    "b.complaint_acceptance_province,b.fault_msisdn,b.fault_area,b.complain_city," +
                    "a.PROPERTY appeal_area,a.crm_ordernum,b.terminal_description,b.td_supported," +
                    "b.analysis_condition,b.customer_dispatch_time,b.demarcation_analysis_results," +
                    "b.cch_sys_delimit_time,b.complain_suggestion1,b.complain_suggestion2," +
                    "b.complain_suggestion3,b.complain_suggestion4,b.complain_suggestion5," +
                    "a.cgi,a.cgi1,a.analysis_result from  (SELECT S1.CITY,S1.PROPERTY," +
                    "S1.CRM_ORDERNUM,S1.ANALYSIS_RESULT,S.SPDB_PROPERTY,S.NSN_PROPERTY,S.NSN_ID," +
                    "S.NSN_PARENT_ID,S1.CGI1,S1.CGI,S1.UE_X,S1.UE_Y FROM (select a1.CITY," +
                    "CASE WHEN a1.CITY='大理' and a1.PROPERTY='大理古城区'  THEN a2.area else " +
                    "a1.PROPERTY end PROPERTY,a1.CRM_ORDERNUM, a1.ANALYSIS_RESULT,a1.cgi1," +
                    "a1.CGI,a1.UE_X,a1.UE_Y from (select T.CITY, T.PROPERTY,F.工单流水号 crm_ordernum," +
                    "F.备注1 analysis_result,F.LTE关键小区 cgi," +
                    "substr(COMPARE_SECTOR,0,instr(T.COMPARE_SECTOR,'(')-1) cgi1,T.UE_X, T.UE_Y " +
                    "from TEMP_CP_COMPLAIN_LIST_ORDER_V1 T,FINAL_ANALYSIS_TABLE_V2_1 F WHERE T.ORDERNUM=F.工单流水号) a1 " +
                    "left join (select SECTOR_ID,AREA from p_lte_sector_bak p) a2 on a1.cgi=a2.SECTOR_ID) S1," +
                    "(SELECT SPDB_PROPERTY, NSN_PROPERTY, NSN_ID, NSN_PARENT_ID FROM spdb_nsn_area_change) S " +
                    "WHERE S1.PROPERTY=S.SPDB_PROPERTY ) a,(select eoms_ordernum as  order_name,businesstype as order_theme," +
                    "to_char(version_date,'yyyy-mm-dd hh24:mi:ss') as order_time,to_char(order_accept_limit_time,'yyyy-mm-dd hh24:mi:ss') as accept_time_limit," +
                    "city,ue_property as region,ue_date as complain_time, customer_name,phonenum as customer_tel, " +
                    ...
                    " complain_suggestion2, complain_suggestion3,complain_suggestion4, complain_suggestion5 " +
                    "from p_lte_parmeter_complaint )b where a.crm_ordernum=b.crm_ordernum";
